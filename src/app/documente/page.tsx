...
const metadata: Metadata = {
  title: "Documente - ONIA",
  description:
    "Regulament oficial, rapoarte, programe și documente oficiale ale Olimpiadei Naționale de Inteligență Artificială.",
};
  ...
  return (
    <div className="bg-white">
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">Documente Oficiale</h1>
          </div>
          <p className="text-xl text-blue-100">
            Regulamente, rapoarte și programe oficiale ale olimpiadei
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Official Documents */}
          <div className="mb-16" id="documente-oficiale">
            <div className="group/section flex items-center justify-between mb-6">
              <h2 className="text-3xl font-bold text-black">Documente oficiale</h2>
              <div className="opacity-0 group-hover/section:opacity-100 transition-opacity duration-200">
                <CopyLinkButton url={typeof window !== 'undefined' ? `${window.location.origin}${window.location.pathname}#documente-oficiale` : ''} />
              </div>
            </div>
